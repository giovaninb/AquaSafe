...
import br.gov.rs.ddpa_seapi.aquasaude.aquasafe.Quiz.Pergunta;
import br.gov.rs.ddpa_seapi.aquasaude.aquasafe.Quiz.Resposta;
import br.gov.rs.ddpa_seapi.aquasaude.aquasafe.Quiz.ListaPerguntas;
import br.gov.rs.ddpa_seapi.aquasaude.aquasafe.Quiz.adapter.RespostasAdapter;
...
//        setSupportActionBar(toolbar);
    ...
    public static class PerguntaFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            textPergunta.setMovementMethod(new ScrollingMovementMethod());
            textPergunta.setText(pergunta.getTitulo());

            GridView gridRespostas = rootView.findViewById(R.id.grid_respostas);
            ...
            btResponde.setOnClickListener(v -> {
                if (btResponde.getText().toString().contains(getString(R.string.confirmar))) {
                    ...
                    if (respostaSelecionada == NENHUMA_RESPOSTA_SELECIONADA) {
                        ...
                        btResponde.setText(R.string.next);
                        ...
                        if (acertou) {
                            ...
                            layout.setBackgroundResource(R.drawable.card_green);
                        } else {
                            //balança a tela
                            ...
                            layoutSelecionado.setBackgroundResource(R.drawable.card_red);
                            //o fundo da questão certa fica verde
                            View layoutCerta = getViewByPosition(respostaCerta, gridRespostas);
                            layoutCerta.setBackgroundResource(R.drawable.card_green);
                        }
                    }
